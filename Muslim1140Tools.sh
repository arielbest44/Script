...
echo ""
echo $b "1.  DDOS ATTACK${enda}";
echo "============================" | lolcat
echo $r "2.  Hack CCTV${endc}";
echo "============================" | lolcat
echo $g "3.  CRATE SCRIPT DEFACE${endc}";
echo "============================" | lolcat
echo $c "4.  DEFECE & TEBAS INDEX &DLL${endc}";
echo "============================" | lolcat
echo $r "5.  CRATE VIRUS${endc}";
echo "============================" | lolcat
...
echo
echo
toilet -f future "    Muslim1140 TOOLS" | lolcat
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo $yellow
figlet -f future "Muslim1140 Tools"
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo
...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"Channel Muslim1140"$cyan" ~/IndoCyber"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo $green "╭─"$blue"Channel Muslim1140"$cyan" ~/IndoCyber"$white
read -p " ╰─$ "  target
echo
